...
function AuthProvider({ children }) {
  ...
  const [userData, setUserData] = useState(tokenData ? JSON.parse(localStorage.getItem('userData')) : null);
  const [isAuthenticated, setIsAuthenticated] = useState(tokenData ? Date.now() <= tokenData.exp * 1000 : false);
